        ...
        <section className="relative min-h-screen flex items-center justify-center px-6 pt-24">
          ...
          <div className="relative z-10 max-w-6xl text-center mt-12">
            <motion.div
              ...
              className="inline-flex px-4 py-2 border border-accent-blue/30 rounded-full text-sm tracking-[3px] uppercase mb-8 bg-accent-blue/10 text-accent-blue font-bold"
            >
              Klyon Digital
            </motion.div>
            ...
            >
              ...
              <a 
                href="#servicos"
                className="px-10 py-5 rounded-2xl border border-white/10 bg-white/10 text-white font-semibold text-lg hover:bg-white/20 transition-colors flex items-center justify-center"
              >
                VER SERVIÇOS
              </a>
            </motion.div>
